...
export default function TeacherChatbot() {
  ...
  return (
    ...
    >
      <h1 className="text-3xl font-bold tracking-tight">Teacher Chatbot</h1>
      <p className={`mt-3 text-sm leading-7 ${isDarkTheme ? "text-slate-300" : "text-slate-600"}`}>
        The chatbot page is now routed through the teacher shell and inherits the shared dark/light
        theme state.
      </p>
    </div>
  );
