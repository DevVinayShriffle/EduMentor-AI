...
export default function TeacherReports() {
  ...
  return (
    ...
    >
      <h1 className="text-3xl font-bold tracking-tight">Teacher Reports</h1>
      <p className={`mt-3 text-sm leading-7 ${isDarkTheme ? "text-slate-300" : "text-slate-600"}`}>
        Reports now inherit theme styling through outlet context and display within the teacher layout
        container.
      </p>
    </div>
  );
