...
export default function TeacherContent() {
  ...
  return (
    ...
    >
      <h1 className="text-3xl font-bold tracking-tight">Teacher Content</h1>
      <p className={`mt-3 text-sm leading-7 ${isDarkTheme ? "text-slate-300" : "text-slate-600"}`}>
        This route is now rendered by the teacher nested layout. Rich content-management UI will be
        added in Phase 5.
      </p>
    </div>
  );
