  ...
  return (
    <header className={`sticky top-0 z-30 border-b backdrop-blur-xl transition-colors duration-500 ${isDarkTheme ? "border-white/10 bg-slate-950/50 shadow-[0_20px_50px_rgba(2,6,23,0.38)]" : "border-slate-200/80 bg-white/85 shadow-[0_12px_36px_rgba(15,23,42,0.06)]"}`}>
      <style>{`
        ...
        .teacher-theme-switch input {
          opacity: 0;
          width: 0;
          height: 0;
        }

        .teacher-theme-switch .slider {
          --background: #28096b;
          position: absolute;
          cursor: pointer;
          inset: 0;
        ...
        .teacher-theme-switch .slider:before {
          position: absolute;
          content: "";
          height: 1.4em;
          width: 1.4em;
        ...
        .teacher-theme-switch input:checked + .slider {
          background-color: #522ba7;
        }

        .teacher-theme-switch input:checked + .slider:before {
