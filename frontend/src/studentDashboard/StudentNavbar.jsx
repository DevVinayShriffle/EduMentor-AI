        ...
        <div className="flex items-center gap-3">
          <button
            ...
            className={`inline-flex h-11 w-11 items-center justify-center rounded-2xl border shadow-sm transition lg:hidden ${
              isDarkTheme
                ? "border-white/12 bg-white/8 text-slate-200 hover:border-cyan-400/50 hover:text-white"
          ...
          <div>
            <p
              className={`text-xs font-semibold uppercase tracking-[0.24em] ${
                isDarkTheme ? "text-cyan-300" : "text-sky-700"
              }`}
            >
              Student Workspace
            </p>
        ...
        <div className="flex items-center gap-3">
          ...
          <button
            ...
            className={`rounded-2xl px-4 py-2.5 text-sm font-semibold text-white transition hover:scale-[1.01] ${
              isDarkTheme
                ? "bg-gradient-to-r from-cyan-500 via-blue-500 to-indigo-500 shadow-[0_18px_50px_rgba(6,182,212,0.22)]"
                : "bg-gradient-to-r from-sky-500 via-blue-500 to-indigo-500 shadow-[0_18px_40px_rgba(37,99,235,0.2)]"
            }`}
          >
            Logout
          </button>
