...
export default function StudentAiTutor() {
  ...
  return (
    ...
    >
      <h1 className="text-3xl font-bold tracking-tight">Student AI Tutor</h1>
      <p className={`mt-3 text-sm leading-7 ${isDarkTheme ? "text-slate-300" : "text-slate-600"}`}>
        The AI Tutor page now renders within the student dashboard shell and inherits theme state.
      </p>
    </div>
  );
}
