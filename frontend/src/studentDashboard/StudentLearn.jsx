...
export default function StudentLearn() {
  ...
  return (
    ...
    >
      <h1 className="text-3xl font-bold tracking-tight">Student Learn</h1>
      <p className={`mt-3 text-sm leading-7 ${isDarkTheme ? "text-slate-300" : "text-slate-600"}`}>
        This route is now rendered by the student nested layout. Rich learning UI will be added in
        Phase 5.
      </p>
    </div>
  );
