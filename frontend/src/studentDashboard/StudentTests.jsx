...
export default function StudentTests() {
  ...
  return (
    ...
    >
      <h1 className="text-3xl font-bold tracking-tight">Student Tests</h1>
      <p className={`mt-3 text-sm leading-7 ${isDarkTheme ? "text-slate-300" : "text-slate-600"}`}>
        The tests page is wired into the student shell and will receive richer assessment UI in Phase 5.
      </p>
    </div>
  );
}
